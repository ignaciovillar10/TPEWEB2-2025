...
class ProductoController {
    ...
    public function create() {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            $m->create($_POST['id_categoria'] ?: null, $_POST['nombre'], $_POST['precio'], $_POST['stock'], $_POST['img']);
    ...
    public function edit() {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            $m->update($id, $_POST['id_categoria'] ?: null, $_POST['nombre'], $_POST['precio'], $_POST['stock'], $_POST['img']);
            header('Location: index.php?action=productos');
            exit;
        }
        $producto = $m->get($id);
